# Farmbot /** * Renvoit (besoin en eau) - (addition des précipitations des 12 prochaines heures) * C'est-à-dire combien de mm d'eau il faut arroser * @param {besoin en eau d'une plante en mm} need */
